...
var Sample = {
    ...
    _getStreamingMode: function () {
        ...
        switch (streamingMode) {
            case "interactive": return Communicator.StreamingMode.Interactive;
            case "all": return Communicator.StreamingMode.All;
            case "ondemand": return Communicator.StreamingMode.OnDemand;
        }
    ...
    _createBrokerViewer: function (serviceBrokerUri) {
        ...
        var serviceRequest = new Communicator.ServiceRequest(rendererType === Communicator.RendererType.Client ?
